(function (root, factory) {
  ...
  NavigationIndex.prototype._containerFor = function (element, root, cacheElements, cacheRects) {
    ...
    else if (hasClass(containerElement, "choice-list")) type = "vertical";
    else if (hasClass(containerElement, "provider-buttons") || hasClass(containerElement, "search-box") || hasClass(containerElement, "detail-actions")) type = "horizontal";
